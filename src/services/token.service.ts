  ...
  public async generateActionToken(
    ...
    switch (type) {
      case ActionTokenTypeEnum.FORGOT_PASSWORD:
        secret = configs.JWS_ACTION_FORGOT_PASSWORD_SECRET;
        expiresIn = configs.JWS_ACTION_FORGOT_PASSWORD_EXPIRES_IN;
        break;
      case ActionTokenTypeEnum.VERIFY_EMAIL:
        secret = configs.JWS_ACTION_VERIFY_EMAIL_SECRET;
        expiresIn = configs.JWS_ACTION_VERIFY_EMAIL_EXPIRES_IN;
        break;
      default:
